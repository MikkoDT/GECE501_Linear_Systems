...
fgr06=Space3D(title="Figure 06",sz=(8,8)) 

#define the figure

fgr06.ax=axes(projection='3d')

fgr06.Labels("The plane Cut parallel to the vertical axis of the cones.")
fgr06.ShowAxes(20)
...
"Equation of a circular plane parallel to cone height axis."
