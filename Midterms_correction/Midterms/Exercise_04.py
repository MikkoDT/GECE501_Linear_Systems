...
Fig4.Labels("The plane cuts the inverted cone at an angle.")
Fig4.ShowAxes(30)
...
nKDisk = 12  # Adjusted to positive for inverted cone
...
Fig4.ax.plot3D(linensVec[0], linensVec[1], linensVec[2], color=(0, 0, 0), linestyle="dashed")
