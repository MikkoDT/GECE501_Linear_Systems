...
Fig5.Labels("The disk cuts the inverted cone at an angle parallel to the lateral surface.")
Fig5.ShowAxes(30)
...
ncz = outer(ones(res), lnz1); "For inverted cone"
Fig5.ax.plot_surface(ncx, ncy, ncz, alpha=.2)

nKDisk = 15  # Adjusted to positive for inverted cone
...
Fig5.ax.plot3D(linensVec[0], linensVec[1], linensVec[2], color=(0, 0, 0), linestyle="dashed")
